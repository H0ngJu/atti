        ...
        child: Column(
          children: [
                    ...
                    const SizedBox(width: 8),
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: _memoryWordsController.text.isNotEmpty ? colorPallet.goldYellow : Colors.white,
            ...
            Container(
              ...
              child: const Text('기억단어란?', textAlign: TextAlign.left,
                style: TextStyle(
            ...
            Container(
              ...
              width: MediaQuery.of(context).size.width * 0.9,
              alignment: Alignment.centerLeft,
              child: const Text('사진과 관련된 단어 중 가족 구성원 외의\n인물, 사물, 사건, 배경 등의 단어를 말합니다.',
