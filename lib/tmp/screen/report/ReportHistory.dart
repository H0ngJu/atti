  ...
  Widget buildReportSection(bool isRecent, String title, List<List<String>> reports) {
    return Column(
      ...
      children: [
        ...
        if (reports.isEmpty)
          const Text('데이터가 없습니다.', style: TextStyle(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${date[0].substring(6, 7)}월 $weekOfMonth주차 기록 보고',
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${date[0].substring(6, 7)}월 $weekOfMonth주차 기록 보고',
                style: const TextStyle(color: Color(0xff737373), fontFamily: 'PretendardRegular',fontSize: 24),
              )
            ],
          ),
        ));
