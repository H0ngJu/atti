...
//           return Center(child: CircularProgressIndicator()); // 로딩 중일 때는 로딩 인디케이터 표시
...
//                           child: Text(
//                             '이번 달 ${reports[0].registeredMemoryCount!.keys.first} ${thisMonth}',
//                             style: TextStyle(
//                                 fontSize: 24, fontWeight: FontWeight.bold),
//                           ),
//                         ),
//                         for (var report in reports)
//                           if (thisMonth.length == 6 && report.registeredMemoryCount!.keys.first.substring(0, 5)+report.registeredMemoryCount!.keys.first.substring(6, 7) == thisMonth
//                           || thisMonth.length == 7 && report.registeredMemoryCount!.keys.first.substring(0, 7) == thisMonth)
//                             ReportHistoryContainer(report : report),
//                       ],
//                     ),
//                     SizedBox(
//                       height: 30,
...
//                         //           (index) => ReportHistoryContainer(report: report,)),
//                         // ),
//                       ],
//                     ),
//                     SizedBox(
...
//   const ReportHistoryContainer({Key? key, required this.report}) : super(key: key);
//
//   @override
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              for (var date in datedummy)
                                if (date[0].substring(6,7) == thisMonth.substring(5))
